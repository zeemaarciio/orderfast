            ...
            <div id="list" class="row">
                ...
                <div class="table-responsive col-md-12">
                    ...
                    while($linhas = mysql_fetch_array($resultado)){
                        echo "<tr>";
                            echo "<td>".$linhas['idRestaurant']."</td>";
                            echo "<td>".$linhas['nomeFantasia']."</td>";
                            echo "<td>".$linhas['emailRestaurant']."</td>";
                            echo "<td>".$linhas['created']."</td>";
                            ?><td><a class='btn btn-success btn-xs' href='view-restaurante?id=<?php echo $linhas['idRestaurant']; ?>'>Visualizar</a> 
                            <a class='btn btn-warning btn-xs' href='editar-restaurante?id=<?php echo $linhas['idRestaurant']; ?>'>Editar</a>
                            <a class='btn btn-danger btn-xs'  href='exclui-restaurante?idExclui=<?php echo $linhas['idRestaurant']; ?>'>Excluir</a><?php
                        echo "<tr>";
                    }
